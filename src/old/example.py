...
# Mapping the model to SQLAlchemy (1/2)
taiga_projects = sqlalchemy.Table(
    "projects_project",
    metadata,
...
app = Starlette(debug=True,
                on_startup=[database.connect, some_startup_task, startup_msg],
                on_shutdown=[database.disconnect, some_shutdown_task, shutdown_msg],
                routes=routes)
...
if __name__ == "__main__":
    uvicorn.run("example:app", host="127.0.0.1", port=10000, log_level="info")